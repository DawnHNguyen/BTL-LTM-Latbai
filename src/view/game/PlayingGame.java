 ...
 * @author dolong
 */
public class PlayingGame extends JFrame implements ActionListener {
    ...
    public PlayingGame(int k, int score) {
        initComponents();
        this.setLocationRelativeTo(null);
        this.setTitle("Lật Hình");
        level = k;
        cn = init(k, score);
...
//		Image image = new ImageIcon(getClass().getResource("/Game/icon/icon" + index + ".jpg")).getImage();
    ...
    public void newGame() {
        this.dispose();
        new PlayingGame(0, 100);
    }

    public void nextGame() {
        this.dispose();
        new PlayingGame(level + 1, Integer.parseInt(score_bt.getText()) + (maxTime - time) / 50);
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PlayingGame(0, 100).setVisible(true);
            }
        });
    }
